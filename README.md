About onnx-caffe2-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/onnx-caffe2-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5183&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/onnx-caffe2-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `onnx-caffe2` can be installed with `conda`:
...
```
mamba install onnx-caffe2
```

It is possible to list all of the versions of `onnx-caffe2` available on your platform with `conda`:
...
```
mamba search onnx-caffe2 --channel conda-forge
```
...
mamba repoquery search onnx-caffe2 --channel conda-forge

# List packages depending on `onnx-caffe2`:
mamba repoquery whoneeds onnx-caffe2 --channel conda-forge

# List dependencies of `onnx-caffe2`:
mamba repoquery depends onnx-caffe2 --channel conda-forge
```
